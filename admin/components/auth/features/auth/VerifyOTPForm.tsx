...
export function VerifyOTPForm() {
  ...
  return (
    <AuthShell
      ...
      subtitle={`Security protocol: A verification code was sent to ${emailParam || 'your admin email'}. Please authenticate to continue.`}
      preTitle="Verification"
      backgroundImage="/auth-images/login_image.avif"
      leftPanelTitle="Nova Command"
      leftPanelSubtitle="Identity & Access Management"
      leftPanelFooter="Secure administrative access is monitored and logged for auditing purposes."
